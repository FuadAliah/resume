        ...
        skills: [
            {
                ...
                text: 'HTML5, CSS3, SASS, JQuery, Bootstrap 3 & 4, AJAX, Javascript, ES6, VueJs, ReactJS, Axios, Fetch API, JSON, Git, Design Slicing, Web Performance, Cross-browser Compatibility, Web Standards, W3C Validation & Design Responsive.',
            },
            {
                id: 2,
                title: 'Design skills',
