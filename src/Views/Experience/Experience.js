...
class Experience extends Component {
    ...
    state = {
        items: [
            ...
            {
                id: 3, company: 'Bayt.com', date: 'SEP. 2019 - present', position: 'UX/UI DESIGNER & FRONT-END DEVELOPER',
                info: [
            ...
            {
                id: 4, company: 'iHorizons', date: 'DES. 2017 - SEP. 2019', position: 'UX/UI DESIGNER',
                info: [
            ...
            {
                id: 5, company: 'Smarteletec', date: 'SEP. 2019 - present', position: 'UX/UI DESIGNER & FRONT-END DEVELOPER',
                info: [
                    ...
                    { id: 3, text: 'Transform your idea into real and highly interactive mobile applications by delivering simpler and effective user experience to the end consumers of the app.' },
                ]
            }
